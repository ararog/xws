---
layout: default
title: XWS - eXtensibe Web Server
nav_order: 1
...
[![Crates.io downloads](https://img.shields.io/crates/d/xws)](https://crates.io/crates/xws) [![crates.io](https://img.shields.io/crates/v/xws?style=flat-square)](https://crates.io/crates/xws) [![Build Status](https://github.com/ararog/xws/actions/workflows/rust.yml/badge.svg?event=push)](https://github.com/ararog/xws/actions/workflows/rust.yml) ![Crates.io MSRV](https://img.shields.io/crates/msrv/xws) [![Documentation](https://docs.rs/xws/badge.svg)](https://docs.rs/xws/latest/xws) [![MIT licensed](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/ararog/xws/blob/main/LICENSE.md)  [![codecov](https://codecov.io/gh/ararog/xws/graph/badge.svg?token=T0HSBAPVSI)](https://codecov.io/gh/ararog/xws)
...
|-------|-------------|---------------|
| [xws](./xws) | Core HTTP server library | [![docs.rs](https://img.shields.io/docsrs/xws/latest)](https://docs.rs/xws) |
| [xws-macros](./xws-macros) | Macros for Vetis | [![docs.rs](https://img.shields.io/docsrs/xws-macros/latest)](https://docs.rs/xws-macros) |
...
- [API Reference](https://docs.rs/xws)
